...
# lightService=LightService_cell()
lightService.lightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_eishomma_1.0_even_rep_existing_rules_2_c.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_eishomma_1.0_even_rep_existing_rules_2_c.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_eishomma_1.0_even_rep_existing_rules_2_c.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_eishomma_1.0_even_rep_existing_rules_2_c.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_eishomma_1.0_even_rep_existing_rules_2_c.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_eishomma_1.0_even_rep_existing_rules_2_c.pth'))
...
posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_eishomma_1.0_even_rep_existing_rules_2_c.npy',allow_pickle=True)
...
gateway = JavaGateway(gateway_parameters=GatewayParameters(port=25343))                   
...
# %%  
    ...
    if epoch%50==0 and epoch!=0:      
        torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v2_{1+int(epoch/50)}_eishomma_1.0_even_rep_existing_rules_2_c.pth')
        torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v2_{1+int(epoch/50)}_eishomma_1.0_even_rep_existing_rules_2_c.pth')
        torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v2_{1+int(epoch/50)}_eishomma_1.0_even_rep_existing_rules_2_c.pth')
        np.save(f'data/lstm/totalEpochRewards_lstm_v2_{1+int(epoch/50)}_eishomma_1.0_even_rep_existing_rules_2_c.npy',totalEpochRewards)
        np.save(f'data/lstm/posReplayMemory_lstm_v2_{1+int(epoch/50)}_eishomma_1.0_even_rep_existing_rules_2_c.npy',posRelayMemory)
        np.save(f'data/lstm/rules_lstm_v2_{1+int(epoch/50)}_eishomma_1.0_even_rep_existing_rules_2_c.npy',rules)
        np.save(f'data/lstm/totalAcc_lstm_v2_{1+int(epoch/50)}_eishomma_1.0_even_rep_existing_rules_2_c.npy',totalAcc)
        

torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.pth')
torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.pth')
torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.pth')
np.save(f'data/lstm/totalEpochRewards_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.npy',totalEpochRewards)


np.save(f'data/lstm/replayMemory_light_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.npy',lightService.replayMemory)
np.save(f'data/lstm/replayMemory_temp_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.npy',rules)
np.save(f'data/lstm/totalAcc_lstm_v2_eishomma_1.0_even_rep_existing_rules_2_c.npy',totalAcc)
