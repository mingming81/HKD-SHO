...
lightService.lightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_eishomma_even_new_rep_2_c.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_eishomma_even_new_rep_2_c.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_eishomma_even_new_rep_2_c.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_eishomma_even_new_rep_2_c.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_eishomma_even_new_rep_2_c.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_eishomma_even_new_rep_2_c.pth'))
...
posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_eishomma_even_new_rep_2_c.npy',allow_pickle=True)
...
#         torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.pth')
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.pth')

#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.npy',totalEpochRewards)
#         np.save(f'data/lstm/replayMemory_light_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.npy',lightService.replayMemory)
#         np.save(f'data/lstm/replayMemory_temp_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.npy',tempService.replayMemory)
#         np.save(f'data/lstm/replayMemory_air_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.npy',airService.replayMemory)
#         np.save(f'data/lstm/posReplayMemory_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.npy',posRelayMemory)
#         np.save(f'data/lstm/rules_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.npy',rules)
#         np.save(f'data/lstm/totalAcc_lstm_v1_{1+int(epoch/50)}_eishomma_even_new_rep_2_c.npy',totalAcc)
        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_even_new_rep_2_c.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_eishomma_even_new_rep_2_c.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_eishomma_even_new_rep_2_c.pth')

np.save(f'data/lstm/totalEpochRewards_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',totalEpochRewards)

np.save(f'data/lstm/replayMemory_light_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',lightService.replayMemory)
np.save(f'data/lstm/replayMemory_temp_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',rules)
np.save(f'data/lstm/lenRules_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',lenRules)
np.save(f'data/lstm/totalAcc_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',totalAcc)


# totalAcc=np.load(f'data/lstm/totalAcc_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',allow_pickle=True)

# print(f'100 acc: {np.average(totalAcc,axis=0)}') 
                
        
# lenRules=np.load(f'data/lstm/lenRules_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',allow_pickle=True)

# print(f'100 lenRules: {np.average(np.average(lenRules,axis=0))}')    


# posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_eishomma_even_new_rep_2_c_100_3.npy',allow_pickle=True)
