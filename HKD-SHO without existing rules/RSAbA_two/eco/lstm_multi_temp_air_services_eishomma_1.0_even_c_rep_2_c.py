...
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_13_temp_air_eishomma_1.0_even_c_rep_2_c.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_13_temp_air_eishomma_1.0_even_c_rep_2_c.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_13_temp_air_eishomma_1.0_even_c_rep_2_c.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_13_temp_air_eishomma_1.0_even_c_rep_2_c.pth'))
...
posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_13_temp_air_eishomma_1.0_even_c_rep_2_c.npy',allow_pickle=True)
...
np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_1.0_even_c_rep_2_c.npy',totalEpochRewards)


np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_1.0_even_c_rep_2_c.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_1.0_even_c_rep_2_c.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_1.0_even_c_rep_2_c.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v1_temp_air_eishomma_1.0_even_c_rep_2_c.npy',rules)
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_1.0_even_c_rep_2_c.npy',totalAcc)
