...
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v2_17_temp_air_eishomma_noeco_even_rep_2_c_retest.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v2_17_temp_air_eishomma_noeco_even_rep_2_c_retest.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v2_17_temp_air_eishomma_noeco_even_rep_2_c_retest.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v2_17_temp_air_eishomma_noeco_even_rep_2_c_retest.pth'))
...
posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v2_17_temp_air_eishomma_noeco_even_rep_2_c_retest.npy',allow_pickle=True)
...
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{7+int(epoch/50)}_temp_air_eishomma_noeco_even_rep_2_c.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{7+int(epoch/50)}_temp_air_eishomma_noeco_even_rep_2_c.pth')

#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{7+int(epoch/50)}_temp_air_eishomma_noeco_even_rep_2_c.npy',totalEpochRewards)

#         np.save(f'data/lstm/replayMemory_temp_lstm_v1_{7+int(epoch/50)}_temp_air_eishomma_noeco_even_rep_2_c.npy',tempService.replayMemory)
#         np.save(f'data/lstm/replayMemory_air_lstm_v1_{7+int(epoch/50)}_temp_air_eishomma_noeco_even_rep_2_c.npy',airService.replayMemory)

#         np.save(f'data/lstm/posReplayMemory_lstm_v1_{7+int(epoch/50)}_temp_air_eishomma_noeco_even_rep_2_c.npy',posRelayMemory)
#         np.save(f'data/lstm/rules_lstm_v1_{7+int(epoch/50)}_temp_air_eishomma_noeco_even_rep_2_c.npy',rules)
#         np.save(f'data/lstm/totalAcc_lstm_v1_{7+int(epoch/50)}_temp_air_eishomma_noeco_even_rep_2_c.npy',totalAcc)

        

# # torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c.pth')
np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_retest_100.npy',totalEpochRewards)

np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_retest_100.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_retest_100.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_retest_100.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_retest_100.npy',rules)
np.save(f'data/lstm/lenRules_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_retest_100.npy',lenRules)
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_retest_100.npy',totalAcc)


# totalAcc=np.load(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_100_3.npy',allow_pickle=True)

# print(f'100 acc: {np.average(totalAcc,axis=0)}') 
                
        
# lenRules=np.load(f'data/lstm/lenRules_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_100_3.npy',allow_pickle=True)

# print(f'100 lenRules: {np.average(np.average(lenRules,axis=0))}')    


# posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_noeco_even_rep_2_c_100_3.npy',allow_pickle=True)
