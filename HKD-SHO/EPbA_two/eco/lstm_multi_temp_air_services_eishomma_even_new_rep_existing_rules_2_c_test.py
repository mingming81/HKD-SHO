...
# tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_22_temp_air_eishomma_even_new_rep_existing_rules_2_c.pth'))
# tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_22_temp_air_eishomma_even_new_rep_existing_rules_2_c.pth'))

# airService=AirService_cell()
# airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_22_temp_air_eishomma_even_new_rep_existing_rules_2_c.pth'))
# airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_22_temp_air_eishomma_even_new_rep_existing_rules_2_c.pth'))
...
# posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_22_temp_air_eishomma_even_new_rep_existing_rules_2_c.npy',allow_pickle=True)
...
# gateway = JavaGateway(gateway_parameters=GatewayParameters(port=15349))                   
...
#                 corr2_euclidean_temp=np.array([distance.euclidean(np.array([i],dtype='float32'),x_t_pos_norm_temp) for i in stateCandidiate_temp]).reshape(-1)
...
#                 corr2_euclidean_air=np.array([distance.euclidean(np.array([i],dtype='float32'),x_t_pos_norm_air) for i in stateCandidiate_air]).reshape(-1)
...
#                     # stateCandidiate2_temp=stateCandidiate2_temp.astype('float32')
...
#                     # x_t_pos_norm2_temp=x_t_pos_norm2_temp.type(torch.float32)
...
#                     # stateCandidiate2_air=stateCandidiate2_air.astype('float32')
...
#                     # x_t_pos_norm2_air=x_t_pos_norm2_air.type(torch.float32)
...
# #         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+10+int(epoch/50)}_temp_air_eishomma_even_new_rep_existing_rules_2_c.pth')
# #         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+10+int(epoch/50)}_temp_air_eishomma_even_new_rep_existing_rules_2_c.pth')

# #         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+10+int(epoch/50)}_temp_air_eishomma_even_new_rep_existing_rules_2_c.npy',totalEpochRewards)
# #         np.save(f'data/lstm/replayMemory_temp_lstm_v1_{1+10+int(epoch/50)}_temp_air_eishomma_even_new_2_c.npy',tempService.replayMemory)
# #         np.save(f'data/lstm/replayMemory_air_lstm_v1_{1+10+int(epoch/50)}_temp_air_eishomma_even_new_rep_existing_rules_rep_existing_rules_2_c.npy',airService.replayMemory)
# #         np.save(f'data/lstm/posReplayMemory_lstm_v1_{1+10+int(epoch/50)}_temp_air_eishomma_even_new_rep_existing_rules_2_c.npy',posRelayMemory)
# #         np.save(f'data/lstm/rules_lstm_v1_{1+10+int(epoch/50)}_temp_air_eishomma_even_new_rep_existing_rules_2_c.npy',rules)
# #         np.save(f'data/lstm/totalAcc_lstm_v1_{1+10+int(epoch/50)}_temp_air_eishomma_even_new_rep_existing_rules_2_c.npy',totalAcc)
        



# # # torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_even.pth')
# # torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c.pth')
# # torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c.pth')

# np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',totalEpochRewards)

# np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',tempService.replayMemory)
# np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',airService.replayMemory)
# np.save(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',posRelayMemory)
# np.save(f'data/lstm/rules_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',rules)
# np.save(f'data/lstm/lenRules_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',lenRules)
# np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',totalAcc)



# totalAcc=np.load(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',allow_pickle=True)

# print(f'100 acc: {np.average(totalAcc,axis=0)}') 
                
        
lenRules=np.load(f'data/lstm/lenRules_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',allow_pickle=True)
...
# posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_even_new_rep_existing_rules_2_c_100_3.npy',allow_pickle=True)
