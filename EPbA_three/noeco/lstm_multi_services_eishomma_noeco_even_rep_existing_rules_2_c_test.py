...
lightService.lightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_37_eishomma_noeco_even_rep_existing_rules_2_c.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_37_eishomma_noeco_even_rep_existing_rules_2_c.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_37_eishomma_noeco_even_rep_existing_rules_2_c.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_37_eishomma_noeco_even_rep_existing_rules_2_c.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_37_eishomma_noeco_even_rep_existing_rules_2_c.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_37_eishomma_noeco_even_rep_existing_rules_2_c.pth'))
...
posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_37_eishomma_noeco_even_rep_existing_rules_2_c.npy',allow_pickle=True)
...
gateway = JavaGateway(gateway_parameters=GatewayParameters(port=15354))                   
random = gateway.jvm.java.util.Random()   

hybrid_system = gateway.entry_point               
hybrid_system.loading("./smartHome.owl")
# value = hybrid_system.getActuatorsDeployedInBuildingSpace("window");
# print(value)
# hybrid_system.runChangeState("nacer","sleeping")
# hybrid_system.loading("./smartHome.owl")
# value = hybrid_system.getActuatorsDeployedInBuildingSpace("window");
# print(value)
...
# %%   
    ...
    for step in range(0,steps):
        ...
        # make changes to x_us_t to the ontology
        ...
        if posRelayMemory[0,14]!=999:
            ...
            if idx_keep.shape[0]!=0:
                ...
                corr2_light=np.array([distance.cosine(i,x_t_pos_norm2_light) for i in stateCandidiate2_light]).reshape(-1)
                ...
                corr2_temp=np.array([distance.euclidean(i,x_t_pos_norm2_temp) for i in stateCandidiate2_temp]).reshape(-1)
                ...
                corr2_air=np.array([distance.cosine(i,x_t_pos_norm2_air) for i in stateCandidiate2_air]).reshape(-1)
                ...
                if idx_corr_temp.shape[0]!=0:
                    ...
                    actionCandidate_temp=actionCandidate[idx_corr_temp,:][:,[1,2,3,5,7]]
                ...
                if idx_corr_air.shape[0]!=0:
                    ...
                    # rules[2,epoch]+=1
                    actionCandidate_air=actionCandidate[idx_corr_air,:][:,[1,2,4,6,7]]
...
#         torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{6+int(epoch/50)}_eishomma_noeco_even_rep_existing_rules_2_c.pth')
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{6+int(epoch/50)}_eishomma_noeco_even_rep_existing_rules_2_c.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{6+int(epoch/50)}_eishomma_noeco_even_rep_existing_rules_2_c.pth')
#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{6+int(epoch/50)}_eishomma_noeco_even_rep_existing_rules_2_c.npy',totalEpochRewards)
#         np.save(f'data/lstm/posReplayMemory_lstm_v1_{6+int(epoch/50)}_eishomma_noeco_even_rep_existing_rules_2_c.npy',posRelayMemory)
#         np.save(f'data/lstm/rules_lstm_v1_{6+int(epoch/50)}_eishomma_noeco_even_rep_existing_rules_2_c.npy',rules)
#         np.save(f'data/lstm/totalAcc_lstm_v1_{6+int(epoch/50)}_eishomma_noeco_even_rep_existing_rules_2_c.npy',totalAcc)
        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c.pth')
np.save(f'data/lstm/totalEpochRewards_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_5.npy',totalEpochRewards)

# np.save(f'data/lstm/replayMemory_light_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_4.npy',lightService.replayMemory)
# np.save(f'data/lstm/replayMemory_temp_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_4.npy',tempService.replayMemory)
# np.save(f'data/lstm/replayMemory_air_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_4.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_5.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_5.npy',rules)
np.save(f'data/lstm/lenRules_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_5.npy',lenRules)
np.save(f'data/lstm/totalAcc_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_5.npy',totalAcc)


# totalAcc=np.load(f'data/lstm/totalAcc_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_4.npy',allow_pickle=True)

# print(f'100 acc: {np.average(totalAcc,axis=0)}') 
                
        
# lenRules=np.load(f'data/lstm/lenRules_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_4.npy',allow_pickle=True)

# print(f'100 lenRules: {np.average(np.average(lenRules,axis=0))}')    


# posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_eishomma_noeco_even_rep_existing_rules_2_c_100_4.npy',allow_pickle=True)
