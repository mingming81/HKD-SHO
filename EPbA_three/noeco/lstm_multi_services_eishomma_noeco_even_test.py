...
lightService.lightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_5_eishomma_noeco_even_trained_services.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_5_eishomma_noeco_even_trained_services.pth'))
...
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_5_eishomma_noeco_even_trained_services.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_5_eishomma_noeco_even_trained_services.pth'))
...
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_5_eishomma_noeco_even_trained_services.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_5_eishomma_noeco_even_trained_services.pth'))
...
np.save(f'data/lstm/totalAcc_lstm_v1_eishomma_noeco_even_100_trained_services.npy',totalAcc)
np.save(f'data/lstm/replayMemory_light_lstm_v1_eishomma_noeco_even_100_trained_services.npy',lightService.replayMemory)
np.save(f'data/lstm/replayMemory_temp_lstm_v1_eishomma_noeco_even_100_trained_services.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_eishomma_noeco_even_100_trained_services.npy',airService.replayMemory)
