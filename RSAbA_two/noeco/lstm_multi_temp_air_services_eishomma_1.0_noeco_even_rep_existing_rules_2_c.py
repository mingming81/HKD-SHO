...
gateway = JavaGateway(gateway_parameters=GatewayParameters(port=25346))                   
...
# %%  
    ...
    if epoch%50==0 and epoch!=0:      
        ...
        torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+15+9+6+42+int(epoch/50)}_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.pth')
        torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+15+9+6+42+int(epoch/50)}_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.pth')
        np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+15+9+6+42+int(epoch/50)}_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',totalEpochRewards)
        np.save(f'data/lstm/posReplayMemory_lstm_v1_{1+15+9+6+42+int(epoch/50)}_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',posRelayMemory)
        np.save(f'data/lstm/rules_lstm_v1_{1+15+9+6+42+int(epoch/50)}_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',rules)
        np.save(f'data/lstm/totalAcc_lstm_v1_{1+15+9+6+42+int(epoch/50)}_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',totalAcc)
...
np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',totalEpochRewards)

np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v1_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',rules)
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_1.0_noeco_even_rep_existing_rules_2_c.npy',totalAcc)
