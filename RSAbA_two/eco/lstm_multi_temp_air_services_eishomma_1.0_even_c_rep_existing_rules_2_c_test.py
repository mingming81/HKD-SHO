...
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_30_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_30_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_30_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_30_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.pth'))
...
posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_30_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.npy',allow_pickle=True)
...
gateway = JavaGateway(gateway_parameters=GatewayParameters(port=15347))                   
        ...
        if posRelayMemory[0,12]!=999:
            ...
            if idx_keep.shape[0]!=0:
                ...
                if idx_corr_temp.shape[0]!=0:
                    ...
                    actionCandidate_temp=actionCandidate[idx_corr_temp,:][:,[2,4]]
...
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{17+int(epoch/50)}_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{17+int(epoch/50)}_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.pth')
#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{17+int(epoch/50)}_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.npy',totalEpochRewards)
#         np.save(f'data/lstm/posReplayMemory_lstm_v1_{17+int(epoch/50)}_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.npy',posRelayMemory)
#         np.save(f'data/lstm/rules_lstm_v1_{17+int(epoch/50)}_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.npy',rules)
#         np.save(f'data/lstm/totalAcc_lstm_v1_{17+int(epoch/50)}_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.npy',totalAcc)

        

# # torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_temp_air_eishomma_1.0_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c.pth')
np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',totalEpochRewards)


np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',rules)
np.save(f'data/lstm/lenRules_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',lenRules)
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',totalAcc)


lenRules=np.load(f'data/lstm/lenRules_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',allow_pickle=True)
        
print(f'100 lenRules: {np.average(np.average(lenRules,axis=0))}')   


# totalAcc=np.load(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',allow_pickle=True)
...
# posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_1.0_even_c_rep_existing_rules_2_c_100_2.npy',allow_pickle=True)
