...
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v2_3_temp_air_eishomma_even_new_existing_rules_2_c.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v2_3_temp_air_eishomma_even_new_existing_rules_2_c.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v2_3_temp_air_eishomma_even_new_existing_rules_2_c.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v2_3_temp_air_eishomma_even_new_existing_rules_2_c.pth'))
...
posRelayMemory=np.load(f'data/lstm/posReplayMemory_lstm_v2_3_temp_air_eishomma_even_new_existing_rules_2_c.npy',allow_pickle=True)
...
gateway = JavaGateway(gateway_parameters=GatewayParameters(port=30502))                   
...
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/50)}_temp_air_eishomma_even_new_existing_rules_2_c.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/50)}_temp_air_eishomma_even_new_existing_rules_2_c.pth')

#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/50)}_temp_air_eishomma_even_new_existing_rules_2_c.npy',totalEpochRewards)
#         np.save(f'data/lstm/replayMemory_temp_lstm_v1_{1+int(epoch/50)}_temp_air_eishomma_even_new_existing_rules_2_c.npy',tempService.replayMemory)
#         np.save(f'data/lstm/replayMemory_air_lstm_v1_{1+int(epoch/50)}_temp_air_eishomma_even_new_existing_rules_2_c.npy',airService.replayMemory)
#         np.save(f'data/lstm/posReplayMemory_lstm_v1_{1+int(epoch/50)}_temp_air_eishomma_even_new_existing_rules_2_c.npy',posRelayMemory)
#         np.save(f'data/lstm/rules_lstm_v1_{1+int(epoch/50)}_temp_air_eishomma_even_new_existing_rules_2_c.npy',rules)
#         np.save(f'data/lstm/totalAcc_lstm_v1_{1+int(epoch/50)}_temp_air_eishomma_even_new_existing_rules_2_c.npy',totalAcc)
        



# # torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_temp_air_eishomma_even_new_existing_rules_2_c.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_temp_air_eishomma_even_new_existing_rules_2_c.pth')

np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_even_new_existing_rules_2_c_100_4.npy',totalEpochRewards)

np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_even_new_existing_rules_2_c_100_4.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_even_new_existing_rules_2_c_100_4.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_even_new_existing_rules_2_c_100_4.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v1_temp_air_eishomma_even_new_existing_rules_2_c_100_4.npy',rules)
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_even_new_existing_rules_2_c_100_4.npy',totalAcc)
