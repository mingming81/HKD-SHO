...
gateway = JavaGateway(gateway_parameters=GatewayParameters(port=25344))                   
...
np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_noeco_even_rep_existing_rules_2_c.npy',totalEpochRewards)

np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_noeco_even_rep_existing_rules_2_c.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_noeco_even_rep_existing_rules_2_c.npy',airService.replayMemory)
np.save(f'data/lstm/posReplayMemory_lstm_v1_temp_air_eishomma_noeco_even_rep_existing_rules_2_c.npy',posRelayMemory)
np.save(f'data/lstm/rules_lstm_v1_temp_air_eishomma_noeco_even_rep_existing_rules_2_c.npy',rules)
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_noeco_even_rep_existing_rules_2_c.npy',totalAcc)
